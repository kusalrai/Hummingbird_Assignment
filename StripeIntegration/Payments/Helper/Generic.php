...
class Generic
{
    ...
    public function getSubscriptionProductsFromOrderItem($orderItem)
    {
        ...
        {
            $product = $this->loadProductById($subscriptionProductId);
            if ($product && $product->getId())
            {
                $products[$subscriptionProductId] = $product;
            }
        }
    ...
    public function assignPaymentData($payment, $data)
    {
        ...
        if (!empty($data['client_side_confirmation']))
        {
            ...
            $payment->setAdditionalInformation('client_side_confirmation', $data['client_side_confirmation']);
